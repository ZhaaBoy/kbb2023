          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="wow fadeInRight">
                ...
                <i class="ion-ios-color-filter-outline wow fadeInRight" data-wow-delay="0.2s"
                  data-wow-duration="0.5s"></i>
                <p class="wow fadeInRight" data-wow-delay="0.2s" data-wow-duration="0.5s">Tools apa saja yang
                  digunakan</p>
                <i class="ion-ios-barcode-outline wow fadeInRight" data-wow-delay="0.4"
                  data-wow-duration="0.5s"></i>
                <p class="wow fadeInRight" data-wow-delay="0.4s" data-wow-duration="0.5s">Links pembelajaran yang
                  berhubungan dengan video</p>
              </div>
            </div>
          </div>
