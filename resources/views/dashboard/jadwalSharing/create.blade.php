        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form class="" action="{{route ('jadwal-sharing.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control summernote @error('deskripsi') is invalid @enderror" value="{{ old('deskripsi') }}" " class='optional' name="deskripsi" data-validate-length-range="5,15" type="text">
                                    @error('deskripsi')
                                        <div class="alert alert-danger"> {{ $message }}</div>
                                    @enderror
