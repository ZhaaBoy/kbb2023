                        ...
                        <form class="" action="{{route ('kategori.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control @error('nama_kategori') is invalid @enderror" value="{{ old('nama_kategori') }}" data-validate-length-range="6" data-validate-words="2" name="nama_kategori" type="text" required="required">
                                    @error('nama_kategori')
